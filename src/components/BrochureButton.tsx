  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="flex flex-col items-center gap-3 bg-[#01472E] px-3 py-5 text-white transition-opacity hover:opacity-80"
      >
        ...
        <span
          className="text-[0.5625rem] font-semibold uppercase tracking-[0.22em]"
