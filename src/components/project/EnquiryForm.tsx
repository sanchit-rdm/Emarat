...
export default function EnquiryForm({
  ...
  return (
    <section
      id="enquiry"
      className="theme-light relative isolate scroll-mt-44 overflow-hidden border-t border-[color:var(--line)] px-4 py-10 sm:px-6 sm:py-[50px] lg:px-10 lg:py-[100px]"
    >
          ...
          <Reveal className="rounded-md border border-[color:var(--line)] bg-[color:var(--bg)]/40 p-5 sm:p-8 lg:p-10">
            ...
            >
              ...
              <div className="border-b border-[color:var(--line)] pb-3 transition-colors focus-within:border-[color:var(--accent)]">
                <label className="block text-xs uppercase tracking-[0.22em] text-[color:var(--muted)]">
                  {messageLabel}
                </label>
                <textarea
                  name="message"
...
function Field({
  ...
  return (
    <div className="border-b border-[color:var(--line)] pb-3 transition-colors focus-within:border-[color:var(--accent)]">
      <label className="block text-xs uppercase tracking-[0.22em] text-[color:var(--muted)]">{label}</label>
      <input
        type={type}
        name={name}
        required={required}
