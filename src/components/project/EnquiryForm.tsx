...
export default function EnquiryForm({
  ...
  return (
    <section
      id="enquiry"
      className="relative isolate scroll-mt-44 overflow-hidden border-t border-[color:var(--line)] bg-[color:var(--bg-alt)] px-4 py-10 sm:px-6 sm:py-[50px] lg:px-10 lg:py-[100px]"
    >
