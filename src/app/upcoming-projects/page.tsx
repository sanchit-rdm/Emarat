...
export const UPCOMING_PROJECTS_FALLBACK: UpcomingProject[] = [
  {
    ...
    slug: "goa",
    title: "Goa",
    tagline: "Modern residences in India's premier lifestyle destination.",
    location: "Goa",
    status: "Coming Soon",
  ...
  },
  {
    ...
    slug: "bhimtal",
    title: "Bhimtal",
    tagline: "Luxury wooden cottages perched above the lake.",
  ...
  },
  {
    ...
    slug: "lakefarms",
    title: "Lakefarms",
    tagline: "Luxury countryside living near Noida International Airport.",
  ...
  },
  {
    ...
    slug: "lansdowne",
    title: "Lansdowne",
    tagline: "An exclusive hilltop retreat across 30 acres of pristine mountain landscape.",
