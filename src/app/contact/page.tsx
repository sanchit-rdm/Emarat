          ...
          <div className="mx-auto grid max-w-[1440px] grid-cols-1 gap-6 md:grid-cols-3 lg:gap-8">
            {contactMethods.map((c, i) => (
              ...
              >
                ...
                <a
                  href={c.href}
                  className="mt-5 block font-display text-2xl tracking-tight transition-colors hover:text-[color:var(--accent)] lg:text-3xl"
                >
                  {c.primary}
                </a>
          ...
          <div className="mx-auto grid max-w-[1440px] grid-cols-12 gap-8 lg:gap-16">
            ...
            <div className="col-span-12 lg:col-span-5">
              ...
              <div className="rounded-md border border-[color:var(--line)] p-8 lg:p-10">
                ...
                <p className="mt-6 font-display text-xl leading-relaxed lg:text-2xl">
                  Emarat Realty<br />
