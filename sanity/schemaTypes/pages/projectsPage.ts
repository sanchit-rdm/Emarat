  ...
  [
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: "enquiryInterestedLabel", title: "Enquiry — “Interested in” Label", type: "string" }),
        defineField({ name: "enquiryNameLabel", title: "Enquiry — Name Label", type: "string" }),
        defineField({ name: "enquiryNamePlaceholder", title: "Enquiry — Name Placeholder", type: "string" }),
        defineField({ name: "enquiryPhoneLabel", title: "Enquiry — Phone Label", type: "string" }),
        defineField({ name: "enquiryPhonePlaceholder", title: "Enquiry — Phone Placeholder", type: "string" }),
        defineField({ name: "enquiryEmailLabel", title: "Enquiry — Email Label", type: "string" }),
        defineField({ name: "enquiryEmailPlaceholder", title: "Enquiry — Email Placeholder", type: "string" }),
        defineField({ name: "enquiryConfigLabel", title: "Enquiry — Configuration Label", type: "string" }),
        defineField({ name: "enquiryConfigPlaceholder", title: "Enquiry — Configuration Placeholder", type: "string" }),
        defineField({
          name: "enquiryConfigOptions",
          title: "Enquiry — Extra Configuration Options",
          type: "array",
          of: [defineArrayMember({ type: "string" })],
        }),
        defineField({ name: "enquiryMessageLabel", title: "Enquiry — Message Label", type: "string" }),
        defineField({ name: "enquiryMessagePlaceholder", title: "Enquiry — Message Placeholder", type: "string" }),
        defineField({ name: "enquiryPrivacy", title: "Enquiry — Privacy Note", type: "string" }),
      ],
    }),
  ]
);
